  ...
  return (
    <div id="pantalla-mis-favoritos" className="flex flex-col min-h-full pb-28 pt-2">
      ...
      <div className="mb-6 rounded-2xl border border-orange-950/10 bg-white p-5 sm:p-6 shadow-xs">
        <div className="flex items-center gap-2 text-orange-900 font-bold text-xs uppercase tracking-wider mb-1">
      ...
      {favoriteTopics.length === 0 ? (
        <div
          ...
          className="rounded-3xl border border-orange-950/10 bg-white p-8 text-center shadow-xs"
        >
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-orange-50 text-orange-700 mb-4 border border-orange-100">
          ...
          <p className="mt-2 text-sm sm:text-base text-stone-600 max-w-sm mx-auto leading-relaxed">
            ...
            <strong className="text-orange-900 font-semibold">"Guardar en mis favoritos"</strong> para tenerla siempre a mano.
          </p>

          <div className="mt-6 pt-4 border-t border-orange-900/10 max-w-xs mx-auto">
            <button
              id="btn-explorar-desde-favoritos"
              type="button"
              onClick={onExploreTopics}
              className="flex w-full items-center justify-center gap-2 rounded-2xl bg-orange-900 py-3.5 px-5 text-sm sm:text-base font-bold text-white shadow-xs transition-all hover:bg-orange-950 active:scale-[0.98] min-h-[48px]"
            >
        ...
        <div className="space-y-3.5">
          {favoriteTopics.map((topic) => (
            <div
              ...
              className="group rounded-2xl border border-orange-950/10 bg-white p-4 sm:p-5 shadow-xs transition-all hover:border-orange-700/40 hover:shadow-sm"
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="inline-flex items-center gap-1 rounded-md bg-orange-100/90 px-2 py-0.5 text-[11px] font-semibold text-orange-900">
                      <Sparkles className="h-3 w-3 text-orange-700" />
                      Capítulo {topic.chapterNumber}
                    </span>
                  </div>
                  <h3 className="text-base sm:text-lg font-bold text-orange-950 leading-snug">
                    {topic.title}
                  </h3>
              ...
              <div className="mt-3 pt-3 border-t border-orange-950/5 flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl bg-orange-50 px-3.5 py-2 text-xs sm:text-sm font-bold text-orange-900 hover:bg-orange-100 hover:text-orange-950 transition-colors focus:outline-none"
                >
